...
class AgentSubmissionApiTest(unittest.TestCase):
    ...
    def test_admin_overview_aggregates_users_activity_and_usage(self) -> None:
        ...
        self.assertEqual(data["summary"]["usage"]["request_count"], 2)
        self.assertEqual(data["summary"]["usage"]["total_tokens"], 480)
        ...
        self.assertEqual(data["activity"]["totals"]["api_calls"], 2)
        self.assertEqual(data["users"][0]["user_id"], "user-a")
        self.assertEqual(data["users"][0]["usage"]["request_count"], 2)
        self.assertEqual(data["users"][0]["usage"]["measured_request_count"], 2)
        self.assertEqual(data["users"][0]["usage"]["average_tokens_per_request"], 240)
        self.assertEqual(data["users"][0]["usage"]["average_prompt_tokens_per_request"], 195)
        self.assertEqual(data["users"][0]["usage"]["average_completion_tokens_per_request"], 45)
        self.assertEqual(data["users"][0]["display_name"], "Aarav")
        self.assertEqual(data["users"][0]["usage"]["total_tokens"], 480)
