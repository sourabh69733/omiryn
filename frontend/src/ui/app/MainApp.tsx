      ...
      <div className="chat-workspace">
        ...
        <section className={`chat-card agentic-chat ${loading || !conversation ? "conversation-empty" : ""}`}>
          ...
          <form className="composer" onSubmit={sendMessage}>
            <p className="privacy-note">Chats may be used to create learned signals and improve your Omiryn experience. Avoid sharing secrets, IDs, or data you do not want used for personalization.</p>
